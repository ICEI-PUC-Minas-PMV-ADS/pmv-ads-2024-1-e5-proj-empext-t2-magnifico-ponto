...
|-|-|
|Requisitos que motivaram o teste:|**RNF-010:** Manter um controle preciso do estoque para evitar vendas de produtos esgotados e otimizar a logística de reposição. |
